      ...
      <div className="w-full max-w-md relative">
        ...
        <Card className="border-0 shadow-xl bg-card/80 backdrop-blur-sm">
          ...
          <CardContent className="space-y-4">
            {/* Google Sign Up Button - Hidden on preview deployments */}
            {!isPreview && (
              <>
                <Button
                  type="button"
            ...
            {isPreview && (
              <div className="text-xs text-muted-foreground bg-muted px-3 py-2 rounded-md border text-center">
                Google sign-in is disabled on preview deployments. Use email/password or test on production.
              </div>
            )}
